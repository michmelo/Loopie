...
import "./assets/styles/index.css"  // Estilos base y variables de color
import "./assets/styles/app.css"    // Estilos globales con variables CSS y componentes personalizados (ruta corregida)
